...
setuptools.setup(
    ...
    size and shape of dataset, number of numerical and non-numerical columns, small overview of dataset, missing 
    data statistics, missing data heatmap and provides methodology to impute missing data.""",
